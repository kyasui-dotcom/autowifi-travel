...
const CONTENT: Record<Locale, ArticleContent> = {
  ja: {
    ...
    intro: "イタリアは世界遺産の数が世界最多の国であり、ローマ、フィレンツェ、ベネチアなど見どころが満載です。主要都市では4G LTEが安定しており、eSIMを利用すれば美術館のオンラインチケット購入や地図アプリでの街歩きがスムーズに行えます。EU圏内ローミング対応プランなら、近隣国への移動も安心です。",
    sections: [
      {
        title: "イタリアのモバイル通信事情",
