...
const CONTENT: Record<Locale, ArticleContent> = {
  ja: {
    ...
    intro: "旅行先でeSIMを利用する際、通信速度は快適さを大きく左右します。地図アプリの読み込み、SNSへの写真投稿、ビデオ通話など、用途によって必要な速度は異なります。本ガイドでは、eSIMの速度テスト方法、地域別の期待速度、速度に影響する要因、そしてプロバイダー間の速度比較を詳しく解説します。旅行前にeSIMの速度特性を理解し、最適なプランを選びましょう。",
    sections: [
      {
        title: "eSIMの速度テスト方法",
