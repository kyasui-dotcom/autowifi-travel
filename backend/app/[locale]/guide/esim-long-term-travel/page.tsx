...
const CONTENT: Record<Locale, ArticleContent> = {
  ja: {
    ...
    intro: "数ヶ月から数年にわたって世界を旅するデジタルノマドや長期旅行者にとって、安定した通信環境は仕事と生活の基盤です。eSIMは、国を移動するたびにSIMカードを買い替える手間を省き、柔軟にプランを切り替えられるため、長期旅行に最適です。この記事では、長期旅行者ならではのeSIM活用戦略を解説します。",
    sections: [
      {
