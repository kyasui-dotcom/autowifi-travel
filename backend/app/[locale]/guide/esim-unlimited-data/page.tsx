...
const CONTENT: Record<Locale, ArticleContent> = {
  ja: {
    ...
    intro: "海外旅行でデータ残量を気にせず使いたいなら、無制限データeSIMは魅力的な選択肢です。しかし「無制限」と謳っていても、実際にはフェアユースポリシーや速度制限が設けられていることがほとんどです。本ガイドでは、主要プロバイダーの無制限eSIMプランを比較し、本当にお得なケースと容量制限プランの方が賢い場合を徹底解説します。",
    sections: [
      {
