...
const CONTENT: Record<Locale, ArticleContent> = {
  ja: {
    ...
    intro: "モロッコはマラケシュのメディナ、サハラ砂漠、青い街シャウエンなど、多彩な魅力を持つ旅行先です。主要都市では4G LTEが安定して利用可能で、eSIMを使えばマラケシュ・メナラ空港到着後すぐにタクシー配車アプリやGoogleマップでの移動が可能です。フランス語とアラビア語が公用語のモロッコでは、Google翻訳が強い味方になります。",
    sections: [
      {
        title: "モロッコのモバイル通信事情",
