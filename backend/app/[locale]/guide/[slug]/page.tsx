...
const RELATED_GUIDES: Record<string, string[]> = {
  ...
  "kyoto-demachiyanagi-kamo-walk": ["japan-esim", "kyoto-fushimi-sake-district-walk", "travel-apps-esim", "quiet-tokyo-neighborhoods"],
  "kyoto-fushimi-sake-district-walk": ["japan-esim", "kyoto-nishijin-machiya-lanes", "travel-apps-esim", "esim-for-business-travel"],
